@testset "Force Kernels Smoke and Invariants" begin
    ...
    Simulation.step!(st_lj, Simulation.velocityverlet(st_lj), 1f-3; compute_energy=true)
    ...
    Simulation.step!(st_wca, Simulation.velocityverlet(st_wca), 1f-3; compute_energy=true)
    ...
    Simulation.step!(st_soft, Simulation.velocityverlet(st_soft), 1f-3; compute_energy=true)
